document.addEventListener('DOMContentLoaded', () => {
    ...
    // Botão Adotar: salva nome do pet e redireciona para a tela de sucesso
    ...
    btnAdotar?.addEventListener('click', (e) => {
      ...
      // Ajuste a URL abaixo conforme seu projeto (mantém padrão já usado nas telas)
      const SUCCESS_URL = '/Adoção Iniciada/adocao_iniciada.html'; //
      const url = `${SUCCESS_URL}?pet=${encodeURIComponent(petName)}`;
